...
#
#  # --- Resource Limits ---
#  memoryWarningMb: 6144              # Pause queue before next ticket when RSS exceeds this (MB). 0 = disabled (default: 6144)
#  memoryCriticalMb: 8192            # Abort current execution when RSS exceeds this (MB). 0 = disabled (default: 8192)
